...
using ExitManagement.API.DIResolver;
...
namespace ExitManagement.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ExitManagementDBContext>(options =>
                    options.UseSqlServer(this.Configuration.GetConnectionString("ConnectionString"))
            );
            services.AddControllers();
            services.ExitManagementDIResolver();
            services.AddMemoryCache();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ExitManagement API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint("/swagger/v1/swagger.json", "ExitManagement");
            });
