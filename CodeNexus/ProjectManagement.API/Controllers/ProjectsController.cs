...
namespace ProjectManagement.API.Controllers
{
    ...
    public class ProjectsController : ControllerBase
    {
        ...
        public IActionResult GetAllProjectType(int ProjectTypeId)
        {
            try
            {
                return Ok(
                    new
                    {
                        ...
                        Data = _pmServices.GetAllProjectType()
                    }) ;
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllProjectType", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
        ...
        [HttpGet]
        [Route("GetAllCurrencyType")]
        public IActionResult GetAllCurrencyType()
        {
            try
            {
                return Ok(
                    new
                    {
                        StatusCode = "SUCCESS",
                        StatusText = string.Empty,
                        Data = _pmServices.GetAllCurrencyType()
                    });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllCurrencyType", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = "Unexpected error occurred. Try again.",
        ...
        #region Get Project Sub Type
        [HttpGet]
        [Route("GetAllProjectSubType")]
            ...
            try
            {
                return Ok(
                    new
                    {
                        StatusCode = "SUCCESS",
                        StatusText = string.Empty,
                        Data = _pmServices.GetAllProjectSubType()
                    });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllProjectSubType", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = "Unexpected error occurred. Try again.",
                    Data = new AppConstants()
                });
            }
        }
        #endregion
        ...
        [HttpGet]
        [Route("GetAllRateFrequency")]
        public IActionResult GetAllRateFrequency()
        {
            try
            {
                return Ok(
                    new
                    {
                        StatusCode = "SUCCESS",
                        StatusText = string.Empty,
                        Data = _pmServices.GetAllRateFrequency()
                    });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllRateFrequency", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = "Unexpected error occurred. Try again.",
                    Data = new RateFrequency()
                });
            }
        }
        #endregion
            ...
            try
            {
                return Ok(
                    new
                    {
                        StatusCode = "SUCCESS",
                        StatusText = string.Empty,
                        Data = _pmServices.GetAllAllocation()
                    }); 
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllAllocation()", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = "Unexpected error occurred. Try again.",
        ...
        #region Get All Project Role
        [HttpGet]
        [Route("GetAllProjectRole")]
        public IActionResult GetAllProjectRole()
            ...
            try
            {
                return Ok(
                    new
                    {
                        StatusCode = "SUCCESS",
                        StatusText = string.Empty,
                        Data = _pmServices.GetAllProjectRole()
                    });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetAllProjectRole()", Convert.ToString(""));
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = "Unexpected error occurred. Try again.",
  ...
  */
        ...
        /*   #region Get Projects By Project Lead Id
           [HttpGet]
           [Route("GetProjectsByEmployeeId/{employeeId}")]
           public IActionResult GetProjectsByProjectleadId(int employeeId)
           {
               ...
               {
                   LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetProjectsByProjectleadId", "ResorceId" + employeeId.ToString());
                   return Ok(new
                   {
                       StatusCode = "FAILURE",
                       StatusText = "Unexpected error occurred. Try again.",
        ...
        [HttpGet]
        [Route("GetFinanceHeadProjects")]
        public IActionResult GetFinanceHeadProjectsByEmployeeId(int EmployeeId)
        {
            try
            {
                return Ok(new
                {
                    StatusCode = "SUCCESS",
                    Data = _pmServices.GetFinanceHeadProjectsByEmployeeId(EmployeeId)
                });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/", JsonConvert.SerializeObject(EmployeeId));
            }
        ...
        #region Get Projects For BU

        [HttpGet]
        [Route("GetProjectsForBU")]
        public IActionResult GetProjectsByBUs(int EmployeeId)
        {
            try
            {
                return Ok(new
                {
                    StatusCode = "SUCCESS",
                    Data = _pmServices.GetProjectsByBU(EmployeeId)
                });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Projects", "Projects/GetProjectsForBU", JsonConvert.SerializeObject(EmployeeId));
            }
        ...
        public IActionResult ApproveOrRejectChangeRequest(ApproveOrRejectChangeRequest pApproveOrRejectCR)
        {
            try
            {
                ...
                bool result = _pmServices.ApproveOrRejectChangeRequestById(pApproveOrRejectCR).Result;
                if (result)
                {
                    if (pApproveOrRejectCR.ChangeRequestStatus == "Action Required")
                        return Ok(new { StatusCode = "SUCCESS", StatusText = "Change request(s) are saved successfully.", Data = pApproveOrRejectCR.ChangeRequestId });
