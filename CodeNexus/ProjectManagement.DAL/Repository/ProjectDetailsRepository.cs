...
namespace ProjectManagement.DAL.Repository
{
    public interface IProjectDetailsRepository : IBaseRepository<ProjectDetails>
    {
        ...
        List<ProjectDetails> GetProjectsByEngineeringLeadId(int employeeId);


        List<ProjectDetails> GetProjectsByAccountManagerId(int id);
       ProjectDetails UpdatProjectsByAccountManager(ProjectDetails pProjectDetails);
    }
    public class ProjectDetailsRepository : BaseRepository<ProjectDetails>, IProjectDetailsRepository
    {
        ...
        public List<ProjectDetails> GetProjectsByEngineeringLeadId(int employeeId)
        {
            ...
            return dbContext.ProjectDetails.Where(x => x.EngineeringLeadId == employeeId).ToList();
         }
        ...
        List<ProjectDetails> IProjectDetailsRepository.GetProjectsByAccountManagerId(int id)
        {
            return dbContext.ProjectDetails.Where(x => x.AccountId == id).ToList();
        }
        ...
        public ProjectDetails UpdatProjectsByAccountManager(ProjectDetails pProjectDetails)
        {
        ...
        {
            return dbContext.Frequencies.ToList();
        }
