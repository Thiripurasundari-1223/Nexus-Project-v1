...
namespace ProjectManagement.DAL.Repository
{
    public interface IResouceAllocationRepository : IBaseRepository<ResourceAllocation>
    {
        ...
        // ResourceAllocation GetResourceByIterationID(int projectId);
    ...
    public class ResourceAllocationRepository : BaseRepository<ResourceAllocation>, IResouceAllocationRepository
    {
        ...
        /* public ResourceAllocation GetResourceByIterationID(int projectId)
         {


             var resource = from a in _dbContext.ResourceAllocation
                            join b in _dbContext.FixedIteration on a.IterationID equals b.IterationID
                            where b.ProjectID == projectId select a;

             return (ResourceAllocation)resource;
