...
Go
alter table [dbo].[Timesheet] alter column [TotalClockedHours] nvarchar(15) NULL
Go
alter table [dbo].[Timesheet] alter column [TotalApprovedHours] nvarchar(15) NULL
GO
drop table TimesheetLog
Go
